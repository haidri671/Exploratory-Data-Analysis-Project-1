This repository containts files for generation of R plots in R
4 R scripts are provided for graphs creation while 4 final PNG files are also there which will appear as a final product. 
Link to the dataet is provided below. 
...
strptime()
strptime()start color red, start verbatim, strptime(), end verbatim, end color red  and 
as.Date()
as.Date()start color red, start verbatim, as.Date(), end verbatim, end color red functions.

Note that in this dataset missing values are coded as 
?
?start color red, start verbatim, question mark, end verbatim, end color red.
